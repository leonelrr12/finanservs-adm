...
const Show = () => {
  ...
  return ( 
    <div className="w-50 m-auto">
      <h2 className="text-center mt-5">Tipos de Documentos Requeridos</h2>
      <div className="my-2 d-flex justify-content-end">
        <Link to={"/type_documents/new"} className="btn btn-primary btn-md ">Nuevo</Link>
      </div>
          ...
          {(typeof(data) === "object") ? 
            data.map(item => {
              ...
              <tr key={item.id}>
                ...
                <td>
                  <Link to={"/type_documents/edit/" + item.id} className="btn btn-warning btn-sm">Editar</Link>
