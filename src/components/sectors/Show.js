...
const Show = () => {
  ...
  return ( 
    <div className="container-sm mt-3 m-auto">
      <h2 className="text-center">Sector Laboral</h2>
            ...
            data.map(sector => {
              ...
              <tr key={sector.id}>
                ...
                <td className="text-center">
                  ...
                  <button onClick={() => {delRecord(sector.id)}} className="btn btn-danger btn-sm mx-2 m-0">Borrar</button>
                </td>
              </tr>
              )})
            :
